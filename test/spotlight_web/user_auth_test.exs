defmodule SpotlightWeb.UserAuthTest do
  use SpotlightWeb.ConnCase, async: true

  alias Spotlight.Accounts
  alias Spotlight.Accounts.Scope
  alias SpotlightWeb.UserAuth

  import Spotlight.AccountsFixtures

  @remember_me_cookie "_spotlight_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, SpotlightWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
