...
config :spotlight, :scopes,
  user: [
    default: true,
    module: Spotlight.Accounts.Scope,
    assign_key: :current_scope,
    access_path: [:user, :id],
    schema_key: :user_id,
    schema_type: :binary_id,
    schema_table: :users,
    test_data_fixture: Spotlight.AccountsFixtures,
...
config :spotlight, SpotlightWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: SpotlightWeb.ErrorHTML, json: SpotlightWeb.ErrorJSON],
    layout: false
  ],
...
config :spotlight, Spotlight.Mailer, adapter: Swoosh.Adapters.Local
